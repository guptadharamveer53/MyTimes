...
public class AboutActivity extends AppCompatActivity {
    ...
    private void createLibraryCardViews() {
        ...
        CardView cardViewInfo1 = findViewById(R.id.card_info1);
        ...
        cardViewInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/guptadharamveer53"));
        ...
        cardViewInfo1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sudeepmenon47"));
                startActivity(browserIntent);
            }
        });
