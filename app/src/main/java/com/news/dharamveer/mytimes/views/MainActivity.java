package com.news.dharamveer.mytimes.views;
...
import com.news.dharamveer.mytimes.R;
import com.news.dharamveer.mytimes.adapter.DataAdapter;
import com.news.dharamveer.mytimes.model.ArticleStructure;
import com.news.dharamveer.mytimes.model.Constants;
import com.news.dharamveer.mytimes.model.NewsResponse;
import com.news.dharamveer.mytimes.network.ApiClient;
import com.news.dharamveer.mytimes.network.ApiInterface;
import com.news.dharamveer.mytimes.network.interceptors.OfflineResponseCacheInterceptor;
import com.news.dharamveer.mytimes.network.interceptors.ResponseCacheInterceptor;
import com.news.dharamveer.mytimes.util.UtilityMethods;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (selected) {
                            ...
                            case 27:
                                ...
                                break;
                            case 28:
                                Intent browserSource = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/guptadharamveer53/MyTimes"));
    ...
    **/
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto: guptadharamveer53@gmail.com"));
